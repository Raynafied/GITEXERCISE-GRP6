...
class FitnessApp(tk.Tk):
    ...
    def show_welcome_page(self):
        ...
        welcome_label = ttk.Label(self.frame, text="Welcome to the SheFIT!", font=("Helvetica", 16, "bold"))
        ...
        start_button = ttk.Button(self.frame, text="Get Started", command=self.show_login_page)
        start_button.pack(pady=20)

        # Optional: Add a stylish border or background
        self.frame.config(relief="sunken", borderwidth=5)
    ...
    def change_plan(self):
            ...
            workout_button = tk.Button(self.frame, text="Workout Plan", command=self.show_workout_plan, font=("Segoe Script", 12, "bold"), bg="#DDA0DD", fg="black")
            
            diet_button = tk.Button(self.frame, text="Diet Plan", command=self.show_diet_plan, font=("Segoe Script", 12, "bold"), bg="#DDA0DD", fg="black")
            both_button = tk.Button(self.frame, text="Both Workout and Diet", command=self.show_both_plans, font=("Segoe Script", 12, "bold"), bg="#DDA0DD", fg="black")
